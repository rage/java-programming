...
- You know what user interfaces consist of and know how to launch a graphical user interface.
...
<!-- Google Translate: -->
<img src="../img/material/gui-nappi.png" alt="A window with a button. The button has the text 'This is a button'."/>
...
<!-- Google Translate: -->
<img src="../img/material/gui-nappi-ja-teksti.png" alt="A window with a button and textComponent. The button has the text 'This is a button' and the textComponent contains the text 'Text element'."/>
...
Following the example above create a user interface containing a Button and a Label to the class in the exercise template. The Label must be either on top or on the left side of the Button. <!-- The button should be to the left or above the text component. -->
