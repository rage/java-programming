...
It works, but we can improve it a bit. In practice this is declaring whether a Character is "in the game" or not. We could for example add an attribute "alive", which we could use to make things clearer.
